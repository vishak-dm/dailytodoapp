...
class CalendarTasksAdapter  constructor(private val context: Context, private var tasks: List<TaskData>, private val listener: TaskClickListener) : RecyclerView.Adapter<CalendarTasksAdapter.MyViewHolder>() {
